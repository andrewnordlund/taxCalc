...
/*
	Must now figure out how to deal with the investment and roi.
	Should show different scenarios: unregistered, RRSP, and TFS.

	Options:
	1) After the initial tables, add more tables;
	2) Add more columns to existing tables
	3) Update table contents with new data.

	Option 1 makes it hard to compare, but easy to program.
	Option 2 makes for large tables.  Maybe go with this one?
	Option 3 may make for a lot of info in each TD.  Oh snap and would be very difficult to actually do.

	Since this is Proof of Concept, maybe go with option 1



	Also, with RoI, you have three ways to calculate: interest, dividents, and capital gains.
	3 tbody's?
   */
